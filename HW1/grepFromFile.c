...
/*    Bu program arguman olarak girilen dosya icinde    */
/*     -argüman olarak girilen kelimenin kac kez        */
/*      bulundugunu dondurur                            */
/*                                                      */
/********************************************************/
...
int main(int argc, char *argv[])
{
	...
	/*Dosya size ini bulur*/
	size = findSize(inputFile,argv[1]);
	
	/*Toplam kelimeyi bulur*/
...
/*
*Asil isi yapan kelime sayisini bulan grep fonksiyonum
*/
